...
export const OPTS = {
  ...
  ASP_ZP_FINAL: ['Zirconia (10 working days, 12 days if design approval is required) — One Suite Smile Zirconia', 'PMMA (10 working days, 12 days if design approval is required) — One Suite Smile Stage 4', 'Verification Jig + Custom Tray (7 working days) — One Suite Smile Stage 1', 'Bite Rim (7 working days) — One Suite Smile Stage 2', 'Wax Teeth Setup (7 Working days) — One Suite Smile Stage 3'],
  ASP_LFX_TYPE: ['New LFX Case', 'LFX Cont.'],
  ASP_LFX_FINAL: ['LFX Try In (7 or 6 days to send STL only) — PMMA Locator Fixed Bar — Try In WF', 'LFX Finals (8 days, 6 days for beacon) — PMMA Locator Fixed Bar — Final WF'],
  ASP_RCP_ZIRC: ['Needs mounting', 'No mounting'],
  ...
  PMMA_OPTS: ['Analog Milled mounted', 'Analog Milled No Mounting'],
  SKD_TYPE: ['New (add One Suite Smile PMMA code for charge)', 'Continuation'],
  SKD_FINAL: ['Verification Jig + Custom Tray (7 days) — One Suite Smile Stage 1', 'Bite Rim (7 days) — One Suite Smile Stage 2', 'Wax Teeth Setup (7 days) — One Suite Smile Stage 3', 'PMMA (10 days) — One Suite Smile Stage 4', 'Zirconia (10 days) — One Suite Smile Zirconia', 'Straight to Mill — FMR Zirconia Final (8 days) — Mill and Finish'],
  SKD_RCP_ZIRC: ['Needs mounting', 'No mounting'],
...
export const RESET_MAP = { ccType: ['ccOption', 'ccDavinci', 'ccIcamFee', 'rcpDigital', 'rcpOption'], ccOption: [], rcpDigital: ['rcpOption'], rcpOption: [], aspSub: ['aspType', 'aspFinal', 'aspRcpMat', 'aspRcpZirc', 'aspRcpPmmaType', 'aspRcpVJ', 'aspRcpLfx'], aspType: ['aspFinal', 'aspRcpMat', 'aspRcpZirc', 'aspRcpPmmaType', 'aspRcpVJ', 'aspRcpLfx'], aspFinal: [], aspRcpMat: ['aspRcpZirc', 'aspRcpPmmaType', 'aspRcpVJ'], aspRcpZirc: [], aspRcpPmmaType: ['aspRcpVJ'], aspRcpVJ: [], aspRcpLfx: [], skdType: ['skdFinal', 'skdRcpMat', 'skdRcpZirc', 'skdRcpVJ'], skdFinal: ['skdRcpMat', 'skdRcpZirc', 'skdRcpVJ'], skdRcpMat: ['skdRcpZirc', 'skdRcpVJ', 'skdRcpPmma'], skdRcpZirc: [], skdRcpVJ: [], engFinal: ['engSurgicalAddon'], engSurgicalAddon: [], triBar: ['triArch', 'triFaType', 'triImpType', 'triImpOpt', 'triContOpt', 'triPreSub', 'triPreOpt', 'triSingleOpt', 'triRcpArch', 'triRcpFaOpt'], triArch: ['triFaType', 'triImpType', 'triImpOpt', 'triContOpt', 'triPreSub', 'triPreOpt', 'triSingleOpt', 'triRcpArch', 'triRcpFaOpt'], triFaType: ['triImpType', 'triImpOpt', 'triContOpt', 'triPreSub', 'triPreOpt', 'triRcpArch', 'triRcpFaOpt'], triImpType: ['triImpOpt', 'triRcpArch', 'triRcpFaOpt'], triImpOpt: ['triRcpArch', 'triRcpFaOpt'], triContOpt: ['triRcpArch', 'triRcpFaOpt'], triPreSub: ['triPreOpt', 'triRcpArch', 'triRcpFaOpt'], triPreOpt: ['triRcpArch', 'triRcpFaOpt'], triSingleOpt: ['triRcpArch', 'triRcpFaOpt'], triRcpArch: ['triRcpFaOpt'], triRcpFaOpt: [], addonSel: [] };
